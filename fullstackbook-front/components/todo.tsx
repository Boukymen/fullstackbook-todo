...
export default function ToDo(props: { todo: any; onChange: any; onDelete: any; }) {
    ...
    return (
        <div className={styles.toDoRow} key={todo.id}>
            ...
            <button className={styles.deleteBtn} onClick={() => onDelete(todo.id)}><Image
                src="/material-symbols_delete-outline-sharp.svg" width={24} height={24} alt={''} /></button>
        </div>
    )
}
